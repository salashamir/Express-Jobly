...
describe("GET /companies", function () {
  test("test w/o filters returns all companies", async function () {
  ...
  test("test with minEmployees filter", async function () {
    const resp = await request(app)
      .get("/companies")
  ...
  test("test filtering should fail when minEmployees > maxEmployees", async function () {
    const resp = await request(app)
      .get("/companies")
